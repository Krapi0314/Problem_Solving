...
/*
탐욕법 
문어는 양 옆의 서로 다른 두 문어와 손을 맞잡으므로, 사용하는 손의 번호는 1,2,3 이며,
n이 짝수일 경우 마지막에서 1번째 문어는 1번 손을 사용했고, n번째 문어는 아직 2번 손을 사용하지 않았기 때문에, 항상 1,2,...,1,2가 되고
n이 홀수일 경우 마지막에서 1번째 문어는 1번 손을 사용했고, n번째 문어는 2번 손을 이미 사용했기 때문에, 항상 1,2,...,2,3이 된다 
*/
